	...
	$.fn.flexMenu = function (options) {
		var checkFlexObject,
			s = $.extend({
				...
				'linkText' : '&bull;&bull;&bull;', // [string] What text should we display on the "view more" link?
		...
		return this.each(function () {
			...
			if (needsMenu($lastItem) && numItems > s.threshold && !s.undo && $this.is(':visible')
				&& (s.shouldApply())) {
				var $popup = $('<ul class="dropdown-menu" style="display:none;' + ((s.popupAbsolute) ? ' position: absolute;' : '') + '"></ul>');
