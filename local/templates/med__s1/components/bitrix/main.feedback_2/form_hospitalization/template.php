...
<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">	
		...
		<center><b class="mf-ok-text"><?=GetMessage("PER_S")?></b></center>
		</div>
<div class="col-lg-5 col-sm-5 col-md-5 col-xs-10 control-group">
	...
	<?echo CalendarDate("MESSAGE_2", date('d.m.Y'), "form", "15", "class=\"contact2-cal\"")?>
		...
		<div class="col-lg-1 col-sm-1 col-md-1 col-xs-2">
		<center><b class="mf-ok-text"><?=GetMessage("PER_PO")?></b></center>
		</div>
<div class="col-lg-5 col-sm-5 col-md-5 col-xs-10 control-group">
	<?echo CalendarDate("MESSAGE_3", date('d.m.Y'), "form", "15", "class=\"contact2-cal\"")?>
</div>
