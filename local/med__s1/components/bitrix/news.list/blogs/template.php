...
?>
                	...
                	<div class="blog-box wow" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                        ...
                        <div style="padding: 15px 15px;" class="blog-box-title"><a href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><?=$arItem['NAME']?></a></div>
                        <p><?=$arItem['PREVIEW_TEXT']?></p>
                        <div style="width: 90%; margin: 0px 5%;line-height: 50px;height: 50px;border-top: 1px solid #dcddde;" class="post-meta">                        
