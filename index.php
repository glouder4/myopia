...
<? $APPLICATION->IncludeComponent(
    ...
    <div class="container" id="homepage-long-version-two">
        ...
        <div id="doctor-request-form-block">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-lg-7" id="form-info">
                        <div class="image-wrapper">
                            <img src="<?=SITE_TEMPLATE_PATH?>/artmax-assets/doctor-work.png" alt="Запись к врачу">
                        </div>
                        <div class="title-wrapper">
                            <h6 class="title">Запись к врачу</h6>
                        </div>
                        <div class="description-wrapper">
                            <p>В нашей клинике представлены все основные медицинские направления. Мы с радостью поможем Вам по любым вопросам здоровья и жизни! Доверьтесь нам один раз и Вы останетесь довольны!</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-lg-5">
                        <?$APPLICATION->IncludeComponent(
                            ...
                            array(
                                ...
                                "WEB_FORM_ID" => "1",
                                "COMPONENT_TEMPLATE" => "frontpage-form",
